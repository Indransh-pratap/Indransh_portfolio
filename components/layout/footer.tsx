      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <Button variant="outline" size="icon" asChild>
                <a href="https://github.com/indransh-pratap" target="_blank" rel="noopener noreferrer">
                  <Github className="w-4 h-4" />
                </a>
              </Button>
              <Button variant="outline" size="icon" asChild>
                <a href="https://linkedin.com/in/indransh-pratap-947489375/" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="tel:7906852536" className="text-muted-foreground hover:text-primary transition-colors">
               7906852536
                </a>
              </li>
            </ul>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Indransh Pratap. All rights reserved.
          </p>
